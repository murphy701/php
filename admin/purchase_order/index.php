                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <?php if($row['status'] == 0): ?>
                                        ...
                                        <a class="dropdown-item" href="<?php echo base_url.'admin?page=receiving/manage_delay&po_id='.$row['id'] ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-boxes text-dark"></span> delay</a>
                                        <div class="dropdown-divider"></div>
