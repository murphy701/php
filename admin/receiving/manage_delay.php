...
<div class="card card-outline card-primary">
    ...
    <div class="card-footer py-1 text-center">
        <button class="btn btn-flat btn-primary" type="submit" form="receive">Save</button>
...
<script>
    $(function(){
        ...
        $('#receive').submit(function(e){
			...
			$.ajax({
				url:_base_url_+"classes/Master.php?f=save_bo",
				...
				success:function(resp){
					if(resp.status == 'success'){
						location.replace(_base_url_+"admin/?page=back_order/view_bo&id="+resp.id);
...
/*$('#receive').on('submit', function (event) {
 ...
 }); });these codes check parameters and values*/ 
    function rem(_this){
